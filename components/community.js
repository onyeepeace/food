  ...
  return (
    <div className={comStyles.container}>
      <main className={comStyles.main}>
        {/* <div className={comStyles.grid}></div> */}
        ...
        <div className={comStyles.feed} ref={addToRefs}>
          <div className={comStyles.feedImage}>
            <img className={comStyles.plus} src="/images/plus.png" alt="plus" />
            <img
          ...
          <div className={comStyles.text}>
            <img className={comStyles.line} src="/images/line.png" alt="line" />
            <h4>@buzzfeedfood</h4>
            <p>
